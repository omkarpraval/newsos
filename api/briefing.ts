export default async function handler(req: any, res: any) {
  ...
  const prompt = `You are an elite financial journalist synthesizing ${articles.length} news articles about: "${topic}".
Return JSON keys only: summary, facts[], players[], views[], impact, watchNext[].
